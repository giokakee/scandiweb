            ...
            <div className='imageContainer'>
              <div className='imageList'>
                {product.gallery.map((image, i) => {
                  return (
                    <img
                      onClick={() => this.setState({ imgNum: i })}
                      className={`smallImage  ${
                        i === this.state.imgNum && "imageToShow"
                      }`}
                      key={i}
                      alt='err'
                      src={image}
              ...
              <div className='bigImage'>
                {product.gallery.map((image, i) => {
                  return (
                    <img
                      className={`bigImage-img ${
                        this.state.imgNum === i ? "" : "nonDisplay"
                      }`}
                      key={i}
                      alt='err'
                      src={image}
            ...
            <div className='about'>
                ...
                {product.attributes.map((attribute, i) => {
                  return (
                    <Attribute
                      ...
                      attribute={attribute}
                      id={product.id}
                      setChosenAttribute={(data) => this.setState(data)}
                    />
                  );
                })}
              </div>
              ...
              <div>
                ...
                {product.prices.map((mp, i) => {
                  ...
                  return (
                    <p key={i}>
                      {toShow && mp.currency.symbol} {toShow && mp.amount}
                    </p>
                  );
                })}
                {!product.inStock && (
                  <p className='outOfStock'>Sorry, this item is out of stock</p>
                )}
              </div>
